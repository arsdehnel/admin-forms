var adminGrid = {
  ...
  toggleFilterSelect: function( clickObj ){

    clickObj.next('.auto-admin-filter-data').toggleClass('hide');
  ...
  toggleDropdown: function( clickObj ){

    clickObj.closest('.grid-dropdown').find('.dropdown-menu').toggleClass('hide');
